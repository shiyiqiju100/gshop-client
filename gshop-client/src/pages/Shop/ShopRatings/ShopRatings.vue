<template>
  <div class="ratings">
    <div class="ratings-content">
      ...
      <Split></Split>
      <RatingsFilter :selectType="selectType" :onlyContent="onlyContent" @setSelectType="setSelectType" @toggleOnlyContent="toggleOnlyContent"></RatingsFilter>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        selectType: 2,//0 表示推荐, 1 表示吐槽, 2表示全部 rateType
        onlyContent: true //是否显示只有内容的评价 text
      }
    },
    computed: {
